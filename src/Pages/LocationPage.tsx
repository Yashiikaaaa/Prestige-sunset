    ...
    <div id="location" className="flex flex-col-reverse md:flex-row md:items-start justify-between pt-8 md:py-10 bg-white md:relative md:z-0 scroll-mt-26 overflow-hidden">
      ...
      <div className="w-full md:w-1/2 flex flex-col self-start text-center md:text-left px-5 md:px-10 md:z-1 md:bg-white md:py-5">
        ...
        <p className="text-black text-sm md:text-base xl:text-lg mb-4 max-w-[500px] text-left">
          Strategically located on IVC Road in North Bengaluru, the project enjoys seamless access to the Bengaluru International Airport.
          <br></br> The location is well-connected via NH-44, STRR , and the upcoming Peripheral Ring Road, offering direct routes to Yelahanka, Hebbal, and Devanahalli IT corridors. 
          <br/>With major infrastructure developments and tech parks shaping up in the region, IVC Road is fast emerging as a prime destination for plotted investments.
        </p>
